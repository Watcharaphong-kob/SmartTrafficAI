...
class Vehicle(pygame.sprite.Sprite):
    ...
    def load_vehicle_data_from_xlsx(file_path):
        vehicle_data = []
...
def repeat():
    ...
    while(signals[currentGreen].green>0):   # while the timer of current green signal is not zero
        ...
        if(signals[(currentGreen+1)%(noOfSignals)].red==detectionTime):    # set time of next green signal 
            ...
            # setTime()
        time.sleep(1)
    currentYellow = 3   # set yellow signal on
...
class Main:
    ...
    background = pygame.image.load(r'C:\Users\Kobiz\Documents\Term_2\AI_Tech\Project\SmartTrafficAI\images\mod_int.png')

    screen = pygame.display.set_mode(screenSize)
    pygame.display.set_caption("SIMULATION")

    # Loading signal images and font
    redSignal = pygame.image.load(r'C:\Users\Kobiz\Documents\Term_2\AI_Tech\Project\SmartTrafficAI\images\signals\red.png')
    yellowSignal = pygame.image.load(r'C:\Users\Kobiz\Documents\Term_2\AI_Tech\Project\SmartTrafficAI\images\signals\yellow.png')
    greenSignal = pygame.image.load(r'C:\Users\Kobiz\Documents\Term_2\AI_Tech\Project\SmartTrafficAI\images\signals\green.png')
